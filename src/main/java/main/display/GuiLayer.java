...
public class GuiLayer {
    ...
    public GuiLayer(Window window) {
        this.windowPtr = window.getWindow();
    ...
    public void init() {
        ...
        io.setIniFilename("gui.ini"); // We don't want to save .ini file
...
//        ImGuiFreeType.buildFontAtlas(fontAtlas, ImGuiFreeType.RasterizerFlags.LightHinting);
    ...
    private void startFrame(final float deltaTime) {
        ...
        double[] mousePosX = {0};
        double[] mousePosY = {0};
        float[] winWidth = {mainWindow.getWidth()};
        float[] winHeight = {mainWindow.getHeight()};
